...
public class DataOperation {
    ...
    public void receiverPdfNotify(Message<PlayLoadMessage> message) {
        ...
        // log.info(playLoadMessage.getMessage());
//        JSONObject JJ =JSONObject.parseObject(JSON.toJSONString(playLoadMessage.getMessage()));
//
//        JSONArray j = JSONArray.parseArray(playLoadMessage.getMessage().get("UnitData").toString());
//        log.info(JJ.getJSONArray("UnitData").toJSONString());
